...
var tail = []
var body = preload("res://game/game_elements/mobs/bosses/SnakeBoss/SnakeBody.tscn")

onready var player = get_tree().get_nodes_in_group("player")[0]
onready var animation_player = $AnimationPlayer
onready var death_effect = preload("res://game/game_elements/mobs/mob_projectiles/ExplosionDeathEffect.tscn")
